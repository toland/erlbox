Gem::Specification.new do |s|
  ...
  s.files = ["README.txt", "Rakefile", "lib/erlbox", "lib/erlbox/release.rb", "lib/erlbox/snmp.rb", "lib/erlbox/utils.rb", "lib/erlbox.rb"]
  s.has_rdoc = true
  s.homepage = %q{http://thehive.com/}
  s.rdoc_options = ["--quiet", "--title", "Erlang Toolbox documentation", "--opname", "index.html", "--main", "README.txt"]
  s.require_paths = ["lib"]
